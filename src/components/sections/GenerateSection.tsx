...
export default function GenerateSection() {
  ...
  return (
    <div>
      ...
      {/* Scene Constraint */}
      <div className="mt-5 rounded-lg border border-slate-700 bg-slate-800/40 px-4 py-3">
        ...
        <textarea
          ...
          className="w-full resize-y rounded border border-slate-500 bg-slate-700 px-4 py-2 text-sm text-slate-100 placeholder:text-slate-500 focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/20 focus:outline-none"
        />
      </div>
      ...
      {/* Abstraction Level */}
      <div className="mt-3 rounded-lg border border-slate-700 bg-slate-800/40 px-4 py-4">
      ...
      <div className="mt-3 rounded-lg border border-slate-700 bg-slate-800/40 px-4 py-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          {canSpectrum && (
            <div className="flex items-center gap-2">
              <label className="text-xs text-slate-500">Spectrum Steps</label>
              <div className="flex gap-1">
          ...
          <button
            ...
            className="ml-auto rounded border border-slate-600 px-3 py-1.5 text-xs text-slate-400 transition-colors hover:border-slate-500 hover:text-slate-300 disabled:opacity-50"
          >
      ...
      {hasConcepts && (
        <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
          {selectedConcepts.slice(0, 2).map((c, i) => (
            <div key={c.id} className="rounded-lg border border-slate-600 bg-slate-800/60 p-4">
      ...
      {/* Empty state */}
      {spectrumImages.length === 0 && (
        <div className="mt-6 rounded-lg border border-dashed border-slate-700 px-6 py-16 text-center text-sm text-slate-500">
          {conditions.length === 0
